...
int main(int argc, char **argv) {
  ...
  rocksdb_silk::UndumpOptions undump_options;
  ...
  if (FLAGS_db_options != "") {
    rocksdb_silk::Options parsed_options;
    rocksdb_silk::Status s = rocksdb_silk::GetOptionsFromString(
  ...
  rocksdb_silk::DbUndumpTool tool;
